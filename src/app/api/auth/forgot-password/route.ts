...
const GENERIC_RESPONSE = {
  message: "Si el email existe, te llegará un correo con instrucciones.",
};
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 32px 24px;">
          ...
          <p style="color: #475569; font-size: 14px; margin-bottom: 24px;">
            Hola ${serviceProvider.name}, recibimos una solicitud para restablecer la contraseña de tu cuenta.
          </p>
