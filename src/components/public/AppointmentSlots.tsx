      ...
      <div className="grid grid-cols-2 gap-3">
        {appointments.map((appointment) => (
          <button
            ...
            className="flex flex-col items-start gap-1 rounded-lg border border-[#E0E0DB] bg-[#F4F5F7] p-4 hover:border-[#253551] hover:bg-[#eef1f6] transition-colors text-left"
            aria-label={`Turno a las ${appointment.time} por $${appointment.price.toLocaleString("es-AR")}`}
          >
